...
GRANT USAGE ON SCHEMA shopify TO app_user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA shopify TO app_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA shopify GRANT ALL PRIVILEGES ON TABLES TO app_user;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA shopify TO app_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA shopify GRANT USAGE, SELECT ON SEQUENCES TO app_user;
