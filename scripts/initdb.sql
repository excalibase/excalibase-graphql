...
GRANT ALL ON SCHEMA nosql TO hana001;
...
GRANT ALL ON SCHEMA nosql TO app_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA nosql GRANT ALL ON TABLES TO app_user;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA nosql TO app_user;
