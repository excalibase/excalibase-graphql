...
show_info() {
    ...
    echo "   • GraphQL API: http://localhost:$APP_PORT/{projectId}/graphql"
    echo "   • PostgreSQL:  localhost:$DB_PORT"
    echo ""
    echo "🔍 You can:"
    echo "   • Visit http://localhost:$APP_PORT/{projectId}/graphql in your browser (routes are project-scoped)"
