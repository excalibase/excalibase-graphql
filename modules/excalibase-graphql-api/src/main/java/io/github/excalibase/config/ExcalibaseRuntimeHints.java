...
public class ExcalibaseRuntimeHints implements RuntimeHintsRegistrar {
    ...
    public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
        ...
        registerClass(hints, "io.github.excalibase.CDCEvent", all);
        registerClass(hints, "io.github.excalibase.NatsCDCService", all);
        registerClass(hints, "io.github.excalibase.SubscriptionService", all);
        registerClass(hints, "io.github.excalibase.config.GraphQLWebSocketHandler", all);
